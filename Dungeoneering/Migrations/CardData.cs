...
/* This is an auto-generated file */
    public static class CardData
    {
        ...
        static CardData() {
            ...
            cards.Add(new Card { Id = 22, Rewards = new CardRewards { Attack = 0, Armour = 4, Health = 0, Coins = 0, Weapon = true }, Image = "/Content/img/cards/Solomon_Madini.png", Version = "X", Cost = 4, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 22) });
            ...
            cards.Add(new Card { Id = 83, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Pulverise.png", Version = "X", Cost = 2, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 83) });
            ...
            cards.Add(new Card { Id = 91, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Repurpose.png", Version = "X", Cost = 0, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 91) });
            ...
            cards.Add(new Card { Id = 100, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 2, Weapon = true }, Image = "/Content/img/cards/Ice_Warrior.png", Version = "X", Cost = 0, Health = 4, Active = false, Parent = containers.Single(p => p.Id == 100) });
            ...
            cards.Add(new Card { Id = 139, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 2, Weapon = false }, Image = "/Content/img/cards/Bandit_King.png", Version = "X", Cost = 0, Health = 3, Active = false, Parent = containers.Single(p => p.Id == 139) });
            ...
            cards.Add(new Card { Id = 204, Rewards = new CardRewards { Attack = 0, Armour = 7, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Hope_Devourer.png", Version = "X", Cost = 0, Health = 14, Active = false, Parent = containers.Single(p => p.Id == 204) });
            ...
            cards.Add(new Card { Id = 210, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Smuggler.png", Version = "X", Cost = 3, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 210) });
            ...
            cards.Add(new Card { Id = 265, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Lumpnose.png", Version = "X", Cost = 0, Health = 5, Active = false, Parent = containers.Single(p => p.Id == 265) });
            ...
            cards.Add(new Card { Id = 266, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = true }, Image = "/Content/img/cards/Keris.png", Version = "X", Cost = 3, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 266) });
            ...
            cards.Add(new Card { Id = 268, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 2, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Antifire_Potion.png", Version = "X", Cost = 2, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 268) });
            ...
            cards.Add(new Card { Id = 270, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Chaos_Druid.png", Version = "X", Cost = 0, Health = 3, Active = false, Parent = containers.Single(p => p.Id == 270) });
            ...
            cards.Add(new Card { Id = 271, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Crystal_Flask.png", Version = "X", Cost = 0, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 271) });
            ...
            cards.Add(new Card { Id = 273, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Kaqemeex.png", Version = "X", Cost = 1, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 273) });
            ...
            cards.Add(new Card { Id = 279, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Unstable_Concoction.png", Version = "X", Cost = 0, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 279) });
            ...
            cards.Add(new Card { Id = 282, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Cabin_Boy.png", Version = "X", Cost = 1, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 282) });
            ...
            cards.Add(new Card { Id = 283, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Chain_Shot_Cannon.png", Version = "X", Cost = 0, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 283) });
            ...
            cards.Add(new Card { Id = 287, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Rowdy_Cannoneer.png", Version = "X", Cost = 0, Health = 5, Active = false, Parent = containers.Single(p => p.Id == 287) });
            ...
            cards.Add(new Card { Id = 306, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Vyrewatch.png", Version = "X", Cost = 5, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 306) });
            ...
            cards.Add(new Card { Id = 342, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Explosive_Potion.png", Version = "X", Cost = 2, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 342) });
            ...
            cards.Add(new Card { Id = 343, Rewards = new CardRewards { Attack = 0, Armour = 12, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Mithril_Dragon.png", Version = "X", Cost = 0, Health = 12, Active = false, Parent = containers.Single(p => p.Id == 343) });
            ...
            cards.Add(new Card { Id = 346, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 2, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Afflicted.png", Version = "X", Cost = 0, Health = 4, Active = false, Parent = containers.Single(p => p.Id == 346) });
            ...
            cards.Add(new Card { Id = 364, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Tame.png", Version = "X", Cost = 1, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 364) });
            ...
            cards.Add(new Card { Id = 366, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 2, Weapon = false }, Image = "/Content/img/cards/Mutated_Jadinko.png", Version = "X", Cost = 0, Health = 5, Active = false, Parent = containers.Single(p => p.Id == 366) });
            ...
            cards.Add(new Card { Id = 367, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Gorad.png", Version = "X", Cost = 0, Health = 2, Active = false, Parent = containers.Single(p => p.Id == 367) });
            ...
            containers.Add(new CardContainer { Id = 372, ChronicleId = 414, Archetype = Archetype.Morvran, Name = "Iorwerth Hellhound", Rarity = Rarity.Saphire, Type = CardType.Combat });
            cards.Add(new Card { Id = 372, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 4, Weapon = false }, Image = "/Content/img/cards/Iorwerth_Hellhound.png", Version = "X", Cost = 0, Health = 2, Active = false, Parent = containers.Single(p => p.Id == 372) });
            ...
            cards.Add(new Card { Id = 376, Rewards = new CardRewards { Attack = 0, Armour = 6, Health = 6, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Unicorn.png", Version = "X", Cost = 0, Health = 7, Active = false, Parent = containers.Single(p => p.Id == 376) });
            ...
            cards.Add(new Card { Id = 379, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/Rush_of_Blood.png", Version = "X", Cost = 3, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 379) });
            ...
            cards.Add(new Card { Id = 406, Rewards = new CardRewards { Attack = 0, Armour = 2, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Black_Chinchompa.png", Version = "1498451", Cost = 0, Health = 2, Active = true, Parent = containers.Single(p => p.Id == 390) });
            ...
            cards.Add(new Card { Id = 435, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Clairvoyance.png", Version = "1498451", Cost = 0, Health = 0, Active = true, Parent = containers.Single(p => p.Id == 391) });
            scores.Add(new CardScore { Id = 1248, Archetype = Archetype.Ariane, Score = -1, Card = cards.Single(c => c.Id == 435) });
            ...
            cards.Add(new Card { Id = 409, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 1, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Dagannoth_Fledgling.png", Version = "1498451", Cost = 0, Health = 2, Active = true, Parent = containers.Single(p => p.Id == 128) });
            ...
            scores.Add(new CardScore { Id = 1269, Archetype = Archetype.Linza, Score = -1, Card = cards.Single(c => c.Id == 413) });
            ...
            containers.Add(new CardContainer { Id = 393, ChronicleId = 442, Archetype = Archetype.Morvran, Name = "Goblin Village", Rarity = Rarity.Saphire, Type = CardType.Support });
            cards.Add(new Card { Id = 415, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 2, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Goblin_Village.png", Version = "1498451", Cost = 2, Health = 0, Active = true, Parent = containers.Single(p => p.Id == 393) });
            scores.Add(new CardScore { Id = 1276, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 415) });

            cards.Add(new Card { Id = 416, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 1, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Gorad.png", Version = "1498451", Cost = 0, Health = 2, Active = true, Parent = containers.Single(p => p.Id == 367) });
            scores.Add(new CardScore { Id = 1277, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 416) });

            cards.Add(new Card { Id = 417, Rewards = new CardRewards { Attack = 0, Armour = 3, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Hope_Devourer.png", Version = "1498451", Cost = 0, Health = 15, Active = true, Parent = containers.Single(p => p.Id == 204) });
            scores.Add(new CardScore { Id = 1278, Archetype = Archetype.Ozan, Score = -1, Card = cards.Single(c => c.Id == 417) });

            cards.Add(new Card { Id = 418, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 1, Weapon = true }, Image = "/Content/img/cards/v1_4_4/Ice_Warrior.png", Version = "1498451", Cost = 0, Health = 4, Active = true, Parent = containers.Single(p => p.Id == 100) });
            scores.Add(new CardScore { Id = 1279, Archetype = Archetype.Linza, Score = -1, Card = cards.Single(c => c.Id == 418) });

            cards.Add(new Card { Id = 419, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 5, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Iowerth_Hellhound.png", Version = "1498451", Cost = 0, Health = 2, Active = true, Parent = containers.Single(p => p.Id == 372) });
            scores.Add(new CardScore { Id = 1280, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 419) });

            cards.Add(new Card { Id = 420, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Ling_the_Assassin.png", Version = "1498451", Cost = 0, Health = 0, Active = true, Parent = containers.Single(p => p.Id == 121) });
            scores.Add(new CardScore { Id = 1281, Archetype = Archetype.Ozan, Score = -1, Card = cards.Single(c => c.Id == 420) });

            containers.Add(new CardContainer { Id = 394, ChronicleId = 437, Archetype = Archetype.Ozan, Name = "Loot Cache", Rarity = Rarity.Saphire, Type = CardType.Support });
            cards.Add(new Card { Id = 421, Rewards = new CardRewards { Attack = 0, Armour = 2, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Loot_Cache.png", Version = "1498451", Cost = 2, Health = 0, Active = true, Parent = containers.Single(p => p.Id == 394) });
            scores.Add(new CardScore { Id = 1282, Archetype = Archetype.Ozan, Score = -1, Card = cards.Single(c => c.Id == 421) });

            cards.Add(new Card { Id = 422, Rewards = new CardRewards { Attack = 0, Armour = 12, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Mithril_Dragon.png", Version = "1498451", Cost = 0, Health = 10, Active = true, Parent = containers.Single(p => p.Id == 343) });
            scores.Add(new CardScore { Id = 1284, Archetype = Archetype.TheRaptor, Score = -1, Card = cards.Single(c => c.Id == 422) });
            scores.Add(new CardScore { Id = 1285, Archetype = Archetype.Linza, Score = -1, Card = cards.Single(c => c.Id == 422) });
            scores.Add(new CardScore { Id = 1286, Archetype = Archetype.Ariane, Score = -1, Card = cards.Single(c => c.Id == 422) });
            scores.Add(new CardScore { Id = 1287, Archetype = Archetype.Vanescula, Score = -1, Card = cards.Single(c => c.Id == 422) });
            scores.Add(new CardScore { Id = 1288, Archetype = Archetype.Ozan, Score = -1, Card = cards.Single(c => c.Id == 422) });
            scores.Add(new CardScore { Id = 1289, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 422) });

            cards.Add(new Card { Id = 423, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 2, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Mutated_Jadinko.png", Version = "1498451", Cost = 0, Health = 5, Active = true, Parent = containers.Single(p => p.Id == 366) });
            scores.Add(new CardScore { Id = 1290, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 423) });

            cards.Add(new Card { Id = 424, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Pulverise.png", Version = "1498451", Cost = 2, Health = 0, Active = true, Parent = containers.Single(p => p.Id == 83) });
            scores.Add(new CardScore { Id = 1291, Archetype = Archetype.Linza, Score = -1, Card = cards.Single(c => c.Id == 424) });

            cards.Add(new Card { Id = 425, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Repurpose.png", Version = "1498451", Cost = 0, Health = 0, Active = true, Parent = containers.Single(p => p.Id == 91) });
            scores.Add(new CardScore { Id = 1292, Archetype = Archetype.Linza, Score = -1, Card = cards.Single(c => c.Id == 425) });

            cards.Add(new Card { Id = 426, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Rush_of_Blood.png", Version = "1498451", Cost = 2, Health = 0, Active = true, Parent = containers.Single(p => p.Id == 379) });
            scores.Add(new CardScore { Id = 1293, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 426) });

            cards.Add(new Card { Id = 427, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Tame.png", Version = "1498451", Cost = 1, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 364) });
            ...
            scores.Add(new CardScore { Id = 1295, Archetype = Archetype.TheRaptor, Score = -1, Card = cards.Single(c => c.Id == 428) });
            scores.Add(new CardScore { Id = 1296, Archetype = Archetype.Linza, Score = -1, Card = cards.Single(c => c.Id == 428) });
            scores.Add(new CardScore { Id = 1297, Archetype = Archetype.Ariane, Score = -1, Card = cards.Single(c => c.Id == 428) });
            scores.Add(new CardScore { Id = 1298, Archetype = Archetype.Vanescula, Score = -1, Card = cards.Single(c => c.Id == 428) });
            scores.Add(new CardScore { Id = 1299, Archetype = Archetype.Ozan, Score = -1, Card = cards.Single(c => c.Id == 428) });
            scores.Add(new CardScore { Id = 1300, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 428) });

            cards.Add(new Card { Id = 429, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = true }, Image = "/Content/img/cards/v1_4_4/Tetsu_Katana.png", Version = "1498451", Cost = 7, Health = 0, Active = true, Parent = containers.Single(p => p.Id == 81) });
            scores.Add(new CardScore { Id = 1301, Archetype = Archetype.Linza, Score = -1, Card = cards.Single(c => c.Id == 429) });

            cards.Add(new Card { Id = 430, Rewards = new CardRewards { Attack = 0, Armour = 5, Health = 5, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Unicorn.png", Version = "1498451", Cost = 0, Health = 7, Active = true, Parent = containers.Single(p => p.Id == 376) });
            scores.Add(new CardScore { Id = 1302, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 430) });

            containers.Add(new CardContainer { Id = 396, ChronicleId = 443, Archetype = Archetype.Vanescula, Name = "Vampyre Juvinate", Rarity = Rarity.Saphire, Type = CardType.Combat });
            cards.Add(new Card { Id = 431, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Vampyre_Juvinate.png", Version = "1498451", Cost = 0, Health = 2, Active = true, Parent = containers.Single(p => p.Id == 396) });
            scores.Add(new CardScore { Id = 1303, Archetype = Archetype.Vanescula, Score = -1, Card = cards.Single(c => c.Id == 431) });

            containers.Add(new CardContainer { Id = 397, ChronicleId = 441, Archetype = null, Name = "Zamorakian Recruiter", Rarity = Rarity.Saphire, Type = CardType.Support });
            cards.Add(new Card { Id = 432, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Zamorakian_Recruiter.png", Version = "1498451", Cost = 1, Health = 0, Active = true, Parent = containers.Single(p => p.Id == 397) });
            scores.Add(new CardScore { Id = 1304, Archetype = Archetype.TheRaptor, Score = -1, Card = cards.Single(c => c.Id == 432) });
            scores.Add(new CardScore { Id = 1305, Archetype = Archetype.Linza, Score = -1, Card = cards.Single(c => c.Id == 432) });
            scores.Add(new CardScore { Id = 1306, Archetype = Archetype.Ariane, Score = -1, Card = cards.Single(c => c.Id == 432) });
            scores.Add(new CardScore { Id = 1307, Archetype = Archetype.Vanescula, Score = -1, Card = cards.Single(c => c.Id == 432) });
            scores.Add(new CardScore { Id = 1308, Archetype = Archetype.Ozan, Score = -1, Card = cards.Single(c => c.Id == 432) });
            scores.Add(new CardScore { Id = 1309, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 432) });

            containers.Add(new CardContainer { Id = 398, ChronicleId = 444, Archetype = null, Name = "Zombie Crew", Rarity = Rarity.Saphire, Type = CardType.Combat });
            cards.Add(new Card { Id = 433, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_4/Zombie_Crew.png", Version = "1498451", Cost = 0, Health = 2, Active = true, Parent = containers.Single(p => p.Id == 398) });
            scores.Add(new CardScore { Id = 1310, Archetype = Archetype.TheRaptor, Score = -1, Card = cards.Single(c => c.Id == 433) });
            scores.Add(new CardScore { Id = 1311, Archetype = Archetype.Linza, Score = -1, Card = cards.Single(c => c.Id == 433) });
            scores.Add(new CardScore { Id = 1312, Archetype = Archetype.Ariane, Score = -1, Card = cards.Single(c => c.Id == 433) });
            scores.Add(new CardScore { Id = 1313, Archetype = Archetype.Vanescula, Score = -1, Card = cards.Single(c => c.Id == 433) });
            scores.Add(new CardScore { Id = 1314, Archetype = Archetype.Ozan, Score = -1, Card = cards.Single(c => c.Id == 433) });
            scores.Add(new CardScore { Id = 1315, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 433) });

            containers.Add(new CardContainer { Id = 399, ChronicleId = 440, Archetype = Archetype.TheRaptor, Name = "Zombie Monkey", Rarity = Rarity.Saphire, Type = CardType.Combat });
            ...
            cards.Add(new Card { Id = 436, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_5/Chain_Shot_Cannon.png", Version = "1504344", Cost = 0, Health = 0, Active = false, Parent = containers.Single(p => p.Id == 401) });
            scores.Add(new CardScore { Id = 1323, Archetype = Archetype.TheRaptor, Score = 10, Card = cards.Single(c => c.Id == 436) });
            scores.Add(new CardScore { Id = 1324, Archetype = Archetype.Linza, Score = 10, Card = cards.Single(c => c.Id == 436) });
            scores.Add(new CardScore { Id = 1325, Archetype = Archetype.Ariane, Score = 10, Card = cards.Single(c => c.Id == 436) });
            scores.Add(new CardScore { Id = 1326, Archetype = Archetype.Vanescula, Score = -1, Card = cards.Single(c => c.Id == 436) });
            scores.Add(new CardScore { Id = 1327, Archetype = Archetype.Ozan, Score = 10, Card = cards.Single(c => c.Id == 436) });
            scores.Add(new CardScore { Id = 1328, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 436) });

            containers.Add(new CardContainer { Id = 402, ChronicleId = 26, Archetype = null, Name = "Solomon Madini", Rarity = Rarity.Saphire, Type = CardType.Support });
            cards.Add(new Card { Id = 437, Rewards = new CardRewards { Attack = 0, Armour = 4, Health = 0, Coins = 0, Weapon = true }, Image = "/Content/img/cards/v1_4_5/Solomon_Madini.png", Version = "1504344", Cost = 4, Health = 0, Active = true, Parent = containers.Single(p => p.Id == 402) });
            scores.Add(new CardScore { Id = 1329, Archetype = Archetype.TheRaptor, Score = 90, Card = cards.Single(c => c.Id == 437) });
            scores.Add(new CardScore { Id = 1330, Archetype = Archetype.Linza, Score = 80, Card = cards.Single(c => c.Id == 437) });
            scores.Add(new CardScore { Id = 1331, Archetype = Archetype.Ariane, Score = 80, Card = cards.Single(c => c.Id == 437) });
            scores.Add(new CardScore { Id = 1332, Archetype = Archetype.Vanescula, Score = -1, Card = cards.Single(c => c.Id == 437) });
            scores.Add(new CardScore { Id = 1333, Archetype = Archetype.Ozan, Score = 80, Card = cards.Single(c => c.Id == 437) });
            scores.Add(new CardScore { Id = 1334, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 437) });

            containers.Add(new CardContainer { Id = 403, ChronicleId = 303, Archetype = null, Name = "Keris", Rarity = Rarity.Emerald, Type = CardType.Support });
            cards.Add(new Card { Id = 438, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = true }, Image = "/Content/img/cards/v1_4_5/Keris.png", Version = "1504344", Cost = 3, Health = 0, Active = true, Parent = containers.Single(p => p.Id == 403) });
            scores.Add(new CardScore { Id = 1335, Archetype = Archetype.TheRaptor, Score = 30, Card = cards.Single(c => c.Id == 438) });
            scores.Add(new CardScore { Id = 1336, Archetype = Archetype.Linza, Score = 50, Card = cards.Single(c => c.Id == 438) });
            scores.Add(new CardScore { Id = 1337, Archetype = Archetype.Ariane, Score = 20, Card = cards.Single(c => c.Id == 438) });
            scores.Add(new CardScore { Id = 1338, Archetype = Archetype.Vanescula, Score = -1, Card = cards.Single(c => c.Id == 438) });
            scores.Add(new CardScore { Id = 1339, Archetype = Archetype.Ozan, Score = 20, Card = cards.Single(c => c.Id == 438) });
            scores.Add(new CardScore { Id = 1340, Archetype = Archetype.Morvran, Score = -1, Card = cards.Single(c => c.Id == 438) });

            containers.Add(new CardContainer { Id = 404, ChronicleId = 308, Archetype = null, Name = "Chaos Druid", Rarity = Rarity.Emerald, Type = CardType.Combat });
            cards.Add(new Card { Id = 439, Rewards = new CardRewards { Attack = 0, Armour = 0, Health = 0, Coins = 0, Weapon = false }, Image = "/Content/img/cards/v1_4_5/Chaos_Druid.png", Version = "1504344", Cost = 0, Health = 3, Active = false, Parent = containers.Single(p => p.Id == 404) });
            scores.Add(new CardScore { Id = 1341, Archetype = Archetype.TheRaptor, Score = 30, Card = cards.Single(c => c.Id == 439) });
            scores.Add(new CardScore { Id = 1342, Archetype = Archetype.Linza, Score = 20, Card = cards.Single(c => c.Id == 439) });
            scores.Add(new CardScore { Id = 1343, Archetype = Archetype.Ariane, Score = 20, Card = cards.Single(c => c.Id == 439) });
            scores.Add(new CardScore { Id = 1344, Archetype = Archetype.Vanescula, Score = -1, Card = cards.Single(c => c.Id == 439) });
